...
function register(req) {
    ...
    const schema = Joi.object({
        ...
        // uploadImage: Joi.string().empty().required().messages({
        //     "string.base": `uploadImage should be a type of text`,
        //     "any.empty": 'uploadImage is not allowed to be empty',
        //     "string.required": `uploadImage is Required`,
        //     "string.uploadImage": `uploadImage format not valid`,
        // }),
    })
